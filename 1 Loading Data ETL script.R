...
c202106 <- read_csv("Dataset\\202106-divvy-tripdata.csv")
c202107 <- read_csv("Dataset\\202107-divvy-tripdata.csv")
c202108 <- read_csv("Dataset\\202108-divvy-tripdata.csv")
c202109 <- read_csv("Dataset\\202109-divvy-tripdata.csv")
c202110 <- read_csv("Dataset\\202110-divvy-tripdata.csv")
c202111 <- read_csv("Dataset\\202111-divvy-tripdata.csv")
c202112 <- read_csv("Dataset\\202112-divvy-tripdata.csv")
c202201 <- read_csv("Dataset\\202201-divvy-tripdata.csv")
c202202 <- read_csv("Dataset\\202202-divvy-tripdata.csv")
c202203 <- read_csv("Dataset\\202203-divvy-tripdata.csv")
c202204 <- read_csv("Dataset\\202204-divvy-tripdata.csv")
c202205 <- read_csv("Dataset\\202205-divvy-tripdata.csv")
